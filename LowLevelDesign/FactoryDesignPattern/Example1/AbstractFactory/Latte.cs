public class Latte : Coffee
{
    ...
    {
        Console.WriteLine("Boiling Latte with " + _ingredientsCreatorFactory.GetMilkType() + " milk and " + _ingredientsCreatorFactory.GetSugarType() + " sugar.");
    }
    ...
    {
        Console.WriteLine("Freezing Latte");
    }
}